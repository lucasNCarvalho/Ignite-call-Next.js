    ...
    return (
        <Container>
            <Header>
                ...
                <Text>
                    Defina o intervalo de horários que
                    você está disponível erm cada dia da semana.
                </Text>
                        ...
                        {fields.map((field, index) => {
                            return (
                                <IntervalItem key={field.id}>
                                    ...
                                    <IntervalInputs>
                                        <TextInput size="sm" type="time" step={60} {...register(`intervals.${index}.startTime`)} disabled={intervals[index].enabled === false} />
                                        <TextInput size="sm" type="time" step={60} {...register(`intervals.${index}.endTime`)} disabled={intervals[index].enabled === false} />
                                    </IntervalInputs>
                                </IntervalItem>
                            )
                        })}
